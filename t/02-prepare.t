...
use NuoDBTest;
use DBI;
my $dbh = DBI->connect($dbconnect, $user, $password, { PrintError => 0, schema => 'dbi' });
...
my $dbh_raiseerror = DBI->connect($dbconnect, $user, $password, {PrintError => 0, RaiseError => 1});
eval {
...
my $dbh_disconnect1 = DBI->connect($dbconnect, $user, $password, { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect2 = DBI->connect($dbconnect, $user, $password, { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect3 = DBI->connect($dbconnect, $user, $password, { PrintError => 0, schema => 'dbi' });
...
my $dbh_disconnect4 = DBI->connect($dbconnect, $user, $password, { PrintError => 0, schema => 'dbi' });
